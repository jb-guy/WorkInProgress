import { useRef, useState, useEffect, type RefObject, type FC } from 'react';
  ...
  return (
    <div className="relative w-full h-full">
      <canvas
        ...
        ref={canvasRef}
        className="cursor-grab bg-blue w-full h-full overflow-hidden relative outline-none active:cursor-grabbing"
      />
    </div>
  );
};
